...
<!-- Title: Contributing GithubFlow JetPackComposeHelloWorld -->
...
To contribute to jetpackcompose-hello-world project on [GitHub](https://github.com/luismayta/jetpackcompose-hello-world), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/jetpackcompose-hello-world/pulls).
...
To follow the instructions in this guide and start contributing to jetpackcompose-hello-world project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/jetpackcompose-hello-world.git
```

Now your **upstream** points to **luismayta/jetpackcompose-hello-world**.
...
git fetch upstream # assuming upstream is luismayta/jetpackcompose-hello-world
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/jetpackcompose-hello-world/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
